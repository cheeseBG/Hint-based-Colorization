...
class ColorHintDataset(data.Dataset):
    ...
    def set_mode(self, mode):
        ...
        if mode == "training":
            ...
            x1 = [os.path.join(self.root_path, "test", dirs) for dirs in os.listdir(test_dir)]
            x2 = [os.path.join(self.root_path, "test", dirs) for dirs in os.listdir(test_dir)]
            x3 = [os.path.join(self.root_path, "test", dirs) for dirs in os.listdir(test_dir)]
            x4 = [os.path.join(self.root_path, "test", dirs) for dirs in os.listdir(test_dir)]
